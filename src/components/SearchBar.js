...
const SearchBar = ({
  ...
  showSearchBar,
  setSearchQuery,
  searchSuggestions  // Provide a default empty array here
}) => {
  ...
  return (
    <div className="my-2">
      ...
      {isSearchBoxOpen && searchSuggestions.length > 0 && (
        <div
          ref={wrapperRef}
          className="border-2 z-10 rounded-xl py-2 w-[35rem] border-gray-100 absolute bg-white font-medium shadow-sm"
        >
          <ul>
